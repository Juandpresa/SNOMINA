            ...
            <div class="container_12">
                ...
                <div class="contenPanel">
                    <table>
                        ...
                        <tr>
                            <td class="td">
                                <asp:TextBox ID="txtClase" runat="server" Text="" onkeypress="return isAlphabetKey(event)"
                    ...
                    <asp:GridView ID="gvPrimaRiesgo" runat="server" CssClass="mGrid" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Clase">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtClase" runat="server" onkeypress="return isAlphabetKey(event)"
