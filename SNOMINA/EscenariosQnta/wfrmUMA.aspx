                    ...
                    <asp:GridView ID="gvUMA" runat="server" CssClass="mGrid" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Fecha">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtFecha" runat="server" Text='<%# Eval("Fecha")%>' onkeypress="return isAlphabetKey(event)"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="UMA">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtUMA" runat="server" Text='<%# Eval("UMA")%>' onkeypress="return isAlphabetKey(event)"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="SMG">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtSMG" runat="server" Text='<%# Eval("SMG")%>' onkeypress="return isAlphabetKey(event)"></asp:TextBox>
                                </EditItemTemplate>
                            </asp:TemplateField>
