<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="wfrmDatosEmpleado.aspx.cs" Inherits="EscenariosQnta.wfrmDatosEmpleado" %>
            ...
            <div class="container_12">
                ...
                <div>
                    <asp:GridView runat="server" ID="gvEmpleado" CssClass="mGrid" AutoGenerateColumns="False"
                        OnRowCancelingEdit="gvEmpleado_RowCancelingEdit"
                        OnRowEditing="gvEmpleado_RowEditing" OnRowUpdating="gvEmpleado_RowUpdating" OnRowDataBound="gvEmpleado_RowDataBound">
                        <Columns>
