...
{
    public class CuadroMensajeBasico
    {
        public static string CuadroMensajeBotonHtml = @"<input type='button' value='{0}' class='btn' onclick='{2}' />";

        public static string CuadroMensajeHTML = @"<div id='wholePage' class=page>&nbsp;</div>
        ...
        public static string CuadroMensajeScript = @"var xmlHttpRequest;
                                               function Yes() {{
