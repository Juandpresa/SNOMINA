...
<asp:GridView ID="gvImpuesto" runat="server" CssClass="mGrid" AutoGenerateColumns = "false"  
 AllowPaging="true" 
                ...
                onrowcancelingedit="gvImpuesto_RowCancelingEdit" 
...
<asp:TemplateField   HeaderText = "Cuota Fija">
    <ItemTemplate>
        <asp:Label ID="lblCuotaFija" runat="server"
                Text='<%# Eval("CuotaFija")%>'></asp:Label>
    </ItemTemplate>
    <EditItemTemplate>
        <asp:TextBox ID="txtCuotaFija" runat="server"
            Text='<%# Eval("CuotaFija")%>' onkeypress="return isDecimalKey(event)"></asp:TextBox>
    </EditItemTemplate>
    <FooterTemplate>
...
<asp:TemplateField HeaderText = "Porcentaje">
    ...
    <EditItemTemplate>
        <asp:TextBox ID="txtPorcentaje" runat="server"
            Text='<%# Eval("Porcentaje")%>' onkeypress="return isDecimalKey(event, this);"></asp:TextBox>
    </EditItemTemplate>  
    <FooterTemplate>
