<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrmTipoNomina.aspx.cs" Inherits="EscenariosQnta.wfrmTipoNomina" %>
...
<asp:GridView ID="gvTipoNomina" runat="server" CssClass="mGrid" 
                AutoGenerateColumns = "false" 
                onrowcancelingedit="gvTipoNomina_RowCancelingEdit" 
                onrowediting="gvTipoNomina_RowEditing" 
                onrowupdating="gvTipoNomina_RowUpdating" >
<Columns>
<asp:TemplateField ItemStyle-Width = "30px"  HeaderText = "Id_EjecComer" Visible="false">
    <ItemTemplate>
        <asp:Label ID="lblId_TipoNom" runat="server" 
        Text='<%# Eval("Id_TipoNom")%>'></asp:Label>
    </ItemTemplate>   
</asp:TemplateField>
