<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="wfrmPensionAlimenticia.aspx.cs" Inherits="EscenariosQnta.wfrmPensionAlimenticia" %>
    ...
    <div>
        ...
        <div id="skills">
            <div class="container_12">
                ...
                <div>
                    <asp:GridView ID="gvPensionAlimenticia" runat="server" CssClass="mGrid" AutoGenerateColumns="false"
                        OnRowCancelingEdit="gvPensionAlimenticia_RowCancelingEdit" OnRowEditing="gvPensionAlimenticia_RowEditing"
                        OnRowUpdating="gvPensionAlimenticia_RowUpdating">
                        <Columns>
                            <asp:TemplateField ItemStyle-Width="30px" HeaderText="Id_TpoPensA" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="lblId_TpoPensA" runat="server" Text='<%# Eval("Id_TpoPensA")%>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
