    ...
    public partial class wfrmEscenarios : System.Web.UI.Page
    {
        ...
        private void ObtenTipoArea()
        {
            try
            {
                ...
                ddlClasificacion.Items.Insert(0, new ListItem(">> Seleccione una Opcion <<", "0"));
            }
            catch (Exception ex)
            { }
        }
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (strReturnVlaue == "1")
            {
                ...
                Response.Write("<script>alert('Agregado');</script>");
            }
        }
        ...
        protected void ObtenEscenarioByID(int Id_Escenario)
        {
            try
            {
                ...
                strQuery = string.Format("SP_ObtenEscenariobByID {0}", Id_Escenario);
