<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Site.Master" AutoEventWireup="true"
    CodeBehind="wfrmClienteActulizar.aspx.cs" Inherits="EscenariosQnta.wfrmClienteActulizar" %>
        ...
        <div id="skills">
            <div class="container_12">
                <div style="text-align: right;">
                    <asp:Button runat="server" ID="btnRegresar" Text="<< Regresar" CssClass="btn" OnClick="btnRegresar_Click" />
                </div>
                DATOS GENERALES
                ...
                <div class="contenPanel">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="td">
                                <asp:TextBox ID="txtCP" runat="server" Text="" CssClass="textbox" ></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtPais" runat="server" Text="" CssClass="textbox" ></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="td">
                                <asp:TextBox ID="txtTelefono" runat="server" Text="" CssClass="textbox" ></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtNombreContacto" runat="server" Text="" CssClass="textbox" ></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtCorreoContacto" runat="server" Text="" CssClass="textbox" ></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="td">
                                <asp:DropDownList ID="ddlEjecutivo" runat="server" CssClass="cssDropdown" >
                                </asp:DropDownList>
                            </td>
                            <td class="td">
                                <asp:DropDownList ID="ddlSocio" runat="server" CssClass="cssDropdown" >
                                </asp:DropDownList>
                            </td>
                            <td class="td">
                                <asp:DropDownList ID="ddlAsociado" runat="server" CssClass="cssDropdown" >
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
