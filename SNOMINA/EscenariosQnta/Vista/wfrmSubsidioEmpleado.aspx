<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Site.Master" AutoEventWireup="true"
    CodeBehind="wfrmSubsidioEmpleado.aspx.cs" Inherits="EscenariosQnta.wfrmSubsEmp" %>
            ...
            <div class="container_12">
                ...
                <div style="overflow:auto; height:260px;">
                    <asp:GridView ID="gvSudsidio" runat="server" CssClass="mGrid" AutoGenerateColumns="false"
                        AllowPaging="true" PageSize="50" ShowFooter="true" OnRowCancelingEdit="gvSudsidio_RowCancelingEdit"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Limite Inferior">
                                <ItemTemplate>
                                    <asp:Label ID="lblLimInf" runat="server" Text='<%# Eval("LimInfSubsidio")%>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtLimInf" runat="server" Text='<%# Eval("LimInfSubsidio")%>' onkeypress="return isDecimalKey(event)"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                            ...
                            <asp:TemplateField HeaderText="Limite Superior">
                                <ItemTemplate>
                                    <asp:Label ID="lblLimSup" runat="server" Text='<%# Eval("LimSupSubsidio")%>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtLimSup" runat="server" Text='<%# Eval("LimSupSubsidio")%>' onkeypress="return isDecimalKey(event)"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
                            ...
                            <asp:TemplateField HeaderText="Subsidio">
                                <ItemTemplate>
                                    <asp:Label ID="lblSubsidio" runat="server" Text='<%# Eval("Subsidio")%>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <asp:TextBox ID="txtSubsidio" runat="server" Text='<%# Eval("Subsidio")%>' onkeypress="return isDecimalKey(event)"></asp:TextBox>
                                </EditItemTemplate>
                                <FooterTemplate>
