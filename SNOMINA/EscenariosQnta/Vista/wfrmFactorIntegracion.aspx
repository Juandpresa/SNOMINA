                        ...
                        <table>
                            ...
                            <td>                                
                                    <asp:GridView ID="gvFactor" runat="server" CssClass="mGrid" AutoGenerateColumns="false"
                                        AllowPaging="true"  OnRowCancelingEdit="gvFactor_RowCancelingEdit"
                    ...
                    <asp:GridView ID="gvDetalleFactor" runat="server" CssClass="mGrid" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Otra Prestacion">
                                ...
                                <FooterTemplate>
                                    <asp:TextBox ID="txtOtraPrestacion" runat="server" onkeypress="return isDecimalKey(event, this);" Text="0"></asp:TextBox>
                                </FooterTemplate>
                            </asp:TemplateField>
