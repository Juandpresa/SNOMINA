<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/Site.Master" AutoEventWireup="true" CodeBehind="wfrmEdicionEmpleado.aspx.cs" Inherits="EscenariosQnta.Vista.wfrmEdicionEmpleado" %>
    ...
    <div id="skills">
        ...
        <div class="accordion container" id="accordionExample">
                            ...
                            <div class="contenPanel row">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="ddlEmpleadora" runat="server" CssClass="cssDropdown" 
                                                ...
                                                <asp:UpdatePanel runat="server" ID="UpdatePanel4" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <table>
                                                            <tr>
                                                                <td class="td">
                                                                    <asp:RadioButtonList runat="server" ID="rbtTipoEsquema" CssClass="chkBox" onchange="javascript:showContent()" CausesValidation="True" AutoPostBack="True"  required="required">
                                                                    </asp:RadioButtonList>
                                                                </td>
                                                            </tr>
                                                        </table>
                        ...
                        <div class="container_12 container">
                            ...
                            <div class="contenPanel">
                              ...
                              <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="chkObra" runat="server" CssClass="chkBox" AutoPostBack="True" />
                                        </td>
                                    ...
                                    <ContentTemplate>
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td class="td">
                                                    <asp:DropDownList ID="ddlHorario" runat="server" CssClass="cssDropdown" AutoPostBack="True" required="required">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                        ...
                        <div class="container_12 container">
                            ...
                            <div class="contenPanel">
                                ...
                                <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div>
                                            <asp:Button ID="btbAddTarjeta" runat="server" Text="Agregar" UseSubmitBehavior="False" CssClass="btn btn-success" />
                                            <br />
                                            <br />
                                        </div>
                                        <asp:GridView ID="grd" runat="server" CssClass="table table-responsive-sm" DataKeyNames="Banco" AutoGenerateColumns="false">
                                            <Columns>
                        ...
                        <div class="container_12 container">
                            ...
                            <div class="contenPanel">
                                <table>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBox runat="server" ID="chkAntiguedad" CssClass="chkBox" CausesValidation="True" Text="Presenta Antiguedad"></asp:CheckBox>
                                        </td>
                                        <td>
                                            <div class="panelAntiguedad" style="display: none">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div runat="server" id="divPorSueldo" style="display: none">
                                            <table>
                                                ...
                                                <tr>
                                                    <td class="td">
                                                        <asp:TextBox ID="txtPorcentaje" runat="server" Text="100" CssClass="textbox" onchange="javascript:CalculaPorcentaje()" onkeypress="return isDecimalKey(event, this);"></asp:TextBox>
                                                    </td>
                                                    <td class="td">
                                            ...
                                            <table>
                                                <tr>
                                                    <td>
                                                        <br />
                                                        <br />
                                                        <asp:Button ID="btnEsquema" runat="server" Text="Agregar" UseSubmitBehavior="False" CssClass="btn btn-info"/>
                                                    </td>
                                        ...
                                        <asp:GridView ID="grdEsquemas" runat="server" CssClass="table table-responsive-sm" DataKeyNames="Esquema" AutoGenerateColumns="false">
                                            <Columns>
            ...
            <div>
                <br />
                <br />
                <asp:Button ID="btnGuardar" Text="Guardar" runat="server" CssClass="btnG"/>
            </div>
        </div>
    </div>
