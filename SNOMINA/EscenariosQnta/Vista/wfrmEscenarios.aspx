            ...
            <div class="container_12">
                ...
                <div class="contenPanel">
                    <table>
                        ...
                        <tr>
                            <td class="td">
                                <asp:TextBox ID="txtNomina" runat="server" Text="0" CssClass="textbox"></asp:TextBox>
                                <%--    <asp:RadioButtonList ID="rdlTipoNomina" runat="server" ssClass="chkBox" RepeatDirection="Horizontal">
                                    <asp:ListItem Text="Brutos" ></asp:ListItem>
                                    <asp:ListItem Text="Netos"></asp:ListItem>
                                </asp:RadioButtonList>--%>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtAsimilados" runat="server" Text="0" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtHonorarios" runat="server" Text="0" CssClass="textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="td">
                                <asp:TextBox ID="txtTN" runat="server" Text="0" CssClass="textbox"></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtEZWallet" runat="server" Text="0" CssClass="textbox"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <%--   <td class="td">
                                <asp:TextBox ID="txtOtrosProductos" runat="server" Text="" CssClass="textbox"></asp:TextBox>
                            </td>--%>                            
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                Importe / Porcentaje Comision
                            </td>                                               
                        </tr>
                        <tr>
                            <td>
                                <asp:DropDownList ID="ddlClasificacion" runat="server" CssClass="cssDropdown">
                                </asp:DropDownList>
                            </td>
                            <td class="td">
                                <asp:DropDownList ID="ddlTipoComision" runat="server" CssClass="cssDropdown">
                                </asp:DropDownList>                                
                            </td>
                            <td>
                                <asp:TextBox ID="txtImporteComision" runat="server" Text="" CssClass="textbox"></asp:TextBox>
                            </td>                            
                        </tr>
                        <%-- <tr>
                            <td>
                       ...
                       <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkEsnecarioActual" runat="server" CssClass="chkBox" />
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div style="overflow: auto; height: 260px;">
                    <asp:GridView runat="server" ID="gvEscenario" CssClass="mGrid" AutoGenerateColumns="false"
                        OnRowCancelingEdit="gvEscenario_RowCancelingEdit" OnRowEditing="gvEscenario_RowEditing"
                        OnRowUpdating="gvEscenario_RowUpdating">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Prestacion" SortExpression="Prestacion">
                                ...
                                <EditItemTemplate>
                                    <asp:DropDownList ID="ddlPrestaciongv" runat="server" required>
                                    </asp:DropDownList>
                                </EditItemTemplate>
                            </asp:TemplateField>
