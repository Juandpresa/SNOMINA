                            ...
                            <div class="contenPanel">
                                ...
                                <asp:UpdatePanel runat="server" ID="UpdatePanel2" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <asp:GridView ID="grdEsquemas" runat="server" CssClass="table table-responsive-sm" DataKeyNames="Esquema" AutoGenerateColumns="false" AutoGenerateDeleteButton="True" OnRowDeleting="grd_RowDeleting">
                                            <Columns>
