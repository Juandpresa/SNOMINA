                        ...
                        <div class="container_12 container">
                            ...
                            <div class="contenPanel">
                              ...
                              <asp:UpdatePanel runat="server" id="UpdatePanel1" updatemode="Conditional">        
                                <ContentTemplate>
                                  <asp:Button ID="btbAddTarjeta" runat="server" Text="Button" UseSubmitBehavior="False" OnClick="btbAddTarjeta_Click" />
                                  <asp:GridView ID="grd" runat="server" DataKeyNames="Banco" AutoGenerateColumns="false" AutoGenerateDeleteButton="True" OnRowDeleting="grd_RowDeleting">
                                    <Columns>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Banco">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtGBanco" runat="server" Text='<%# Eval("Banco") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Cuenta">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtGCuenta" runat="server" Text='<%# Eval("Cuenta") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Clabe">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtGClabe" runat="server" Text='<%# Eval("Clabe") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Tarjeta">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtGTarjeta" runat="server" Text='<%# Eval("Tarjeta") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Prioridad">
                                            <ItemTemplate>
                                                <asp:CheckBox ID="chkGPrioridad" runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                      <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="IdBanco">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtGIdBanco" runat="server" Text='<%# Eval("IdBanco") %>'></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
