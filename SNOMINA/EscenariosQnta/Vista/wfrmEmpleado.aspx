                                        ...
                                        <asp:GridView ID="grd" runat="server" CssClass="table table-responsive-sm" DataKeyNames="Banco" AutoGenerateColumns="false" AutoGenerateDeleteButton="True" OnRowDeleting="grd_RowDeleting">
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="Banco">
                                                    <ItemTemplate ID="txtGBanco" runat="server" Text='<%# Eval("Banco") %>'>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="IdBanco" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtGIdBanco" runat="server" Text='<%# Eval("IdBanco") %>' Visible="false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
