...
namespace EscenariosQnta
{
    public partial class wfrmPrestacion : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {                
                Mensaje("ADVERTENCIA: Debe ingresar el nombre de una Prestacion", CuadroMensaje.CuadroMensajeIcono.Error);
            }
            else
            {
        ...
        protected void ObtenPrestaciones()
        {
            ...
            ddlPrestaciones.Items.Insert(0, new ListItem(">> Seleccione una Opcion <<", "-1"));
