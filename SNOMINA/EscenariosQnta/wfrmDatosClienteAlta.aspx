<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="wfrmDatosClienteAlta.aspx.cs" Inherits="EscenariosQnta.wfrmDatosClienteAlta" %>
                ...
                <div class="contenPanel">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="td">
                                <asp:TextBox ID="txtDenominacion" runat="server" Text="" CssClass="textbox" required></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtGiro" runat="server" Text="" CssClass="textbox" required></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="td">
                                <asp:TextBox ID="txtCalle" runat="server" Text="" CssClass="textbox" required></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtColonia" runat="server" Text="" CssClass="textbox" required></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtDelegacion" runat="server" Text="" CssClass="textbox" required></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td class="td">
                                <asp:TextBox ID="txtCP" runat="server" Text="" CssClass="textbox" required onkeypress="return isNumberKey(event)"></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtPais" runat="server" Text="" CssClass="textbox" required></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td class="td">
                                <asp:TextBox ID="txtTelefono" runat="server" Text="" CssClass="textbox" required
                                    placeholder="(___) ___-____"></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtNombreContacto" runat="server" Text="" CssClass="textbox" required></asp:TextBox>
                            </td>
                            <td class="td">
                                <asp:TextBox ID="txtCorreoContacto" runat="server" Text="" CssClass="textbox" required
